...
class ObjectViz {
 public:
  explicit ObjectViz(const rapid::viz::MarkerPub* pub);
  void set_object(const Object& object);
  void Visualize();

 private:
  Object object_;
  const rapid::viz::MarkerPub* pub_;
...
class HSurfaceViz {
 public:
  explicit HSurfaceViz(const rapid::viz::MarkerPub* pub);
...
class SceneViz {
 public:
  explicit SceneViz(const rapid::viz::MarkerPub* pub);
